...
import { useMyMembershipRecords } from "@/hooks/membership/record_reuse/useMyMembershipRecords";
...
const Record = () => {
  const { data: records = [], isLoading } = useMyMembershipRecords();
