...
import apple_earphon from '../../../../public/assets/apple_earphone_image.png'
...
export default function Card({image, title, description, price, rating, key}: CardProps) {
  return (
    <div className="sm:w-fit w-full rounded-xl bg-white p-4 shadow-sm hover:shadow-md transition mx-auto flex flex-col justify-start" key={key}>
      ...
      <div className="mt-2 flex flex-col gap-1">
        ...
        <div className="flex items-center justify-between mt-1">
          <span className="font-semibold text-gray-700 text-sm tracking-wide">{price}</span>

          <button className="rounded-full border px-4 py-1.5 text-xs font-medium
