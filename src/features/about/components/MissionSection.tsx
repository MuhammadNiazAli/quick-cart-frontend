      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-10 sm:mb-12">
          ...
          <p className="text-base sm:text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Our mission is to deeply understand web development and continuously
            explore what can be built with modern technologies. We focus on
            creating powerful digital experiences that deliver real value.
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-12">
          <div className="w-full lg:w-1/2">
            <Image
              src="/assets/67adc42652885fc396b13bfb_634bf413453d9822d0abe0d7_Web-Design-company-in-Mumbai-_-The-Difference-Between-Web-Development-and-Web-Designing-_-SySpree-823x411.jpeg"
              alt="Our Mission"
              width={500}
              height={350}
