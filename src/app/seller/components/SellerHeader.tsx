      ...
      <div className="flex items-center gap-4">
        ...
        >
          ...
          {unreadNotifications > 0 && (
            <span className="absolute -top-0.5 -right-0.5 inline-flex items-center justify-center px-1 py-0.5 text-[10px] font-bold leading-none text-white bg-red-600 rounded-full">
              {unreadNotifications}
            </span>
          )}
        </Link>
        ...
        <button className="bg-[#4B5563] hover:bg-[#2f3439] text-white px-8 py-2 rounded-full text-sm cursor-pointer transition-colors duration-300">
          Logout
        </button>
      </div>
    </header>
